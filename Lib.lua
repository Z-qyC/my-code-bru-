    ...
    -- Esp Library Section  
        ...
        function Library:HitpartPicker(properties)
            ...
            local Items = Cfg.Items; do 
                ...
                -- MAIN CONTAINER (Holds R6, R15, and Bottom Buttons)
                ...
                -- R6 SIDE
                Items.R6Container = Library:Create( "Frame" , {
                    Parent = Items.Container;
                    Name = "\0";
                    Size = dim2(0.5, -5, 1, -35);
                    Position = dim2(0, 0, 0, 0);
                    BackgroundTransparency = 1
                });

                Items.R6Title = Library:Create( "TextLabel" , {
                    Parent = Items.R6Container;
                    Name = "\0";
                    Size = dim2(1, 0, 0, 20);
                    BackgroundTransparency = 1;
                ...
                Items.R6MultiToggle = Library:Create("TextButton", {
                    Parent = Items.R6Container;
                    Name = "\0";
                    Size = dim2(0, 80, 0, 22);
                ...
                -- R15 SIDE
                Items.R15Container = Library:Create( "Frame" , {
                    Parent = Items.Container;
                    Name = "\0";
                    Size = dim2(0.5, -5, 1, -35);
                ...
                Items.R15Title = Library:Create( "TextLabel" , {
                    Parent = Items.R15Container;
                    Name = "\0";
                    Size = dim2(1, 0, 0, 20);
                    BackgroundTransparency = 1;
                    TextColor3 = rgb(200, 200, 200);
                ...
                Items.R15MultiToggle = Library:Create("TextButton", {
                    Parent = Items.R15Container;
                    Name = "\0";
                    Size = dim2(0, 80, 0, 22);
                    Position = dim2(0.5, -40, 1, -30);
                ...
                -- BOTTOM CONTROLS
                Items.BottomControls = Library:Create( "Frame" , {
                    Parent = Items.Container;
                    Name = "\0";
                    Size = dim2(1, 0, 0, 35);
            ...
            -- Helper to create R6 part buttons
            function Cfg.CreateR6Part(name, size, pos)
                ...
                btn.MouseButton1Click:Connect(function()
                    if Cfg.R6Selected[name] then
                        ...
                        if not Cfg.R6MultiMode then
                            for k, _ in pairs(Cfg.R6Selected) do
                                Cfg.R6Selected[k] = nil
                                if Cfg.R6Parts[k] then
                                    Cfg.R6Parts[k].BackgroundColor3 = (k == "HumanoidRootPart") and rgb(40, 40, 40) or rgb(60, 60, 60)
                                end
                            end
                        end
                ...
                Cfg.R6Parts[name] = btn
                return btn
            end

            -- Helper to create R15 part buttons
            function Cfg.CreateR15Part(name, size, pos)
                ...
                btn.MouseButton1Click:Connect(function()
                    if Cfg.R15Selected[name] then
                        ...
                        if not Cfg.R15MultiMode then
                            for k, _ in pairs(Cfg.R15Selected) do
                                Cfg.R15Selected[k] = nil
                                if Cfg.R15Parts[k] then
                                    Cfg.R15Parts[k].BackgroundColor3 = (k == "HumanoidRootPart") and rgb(40, 40, 40) or rgb(60, 60, 60)
                                end
                            end
                        end
                ...
                Cfg.R15Parts[name] = btn
                return btn
            end

            -- GENERATE R6 PARTS
            Cfg.CreateR6Part("Head", dim2(0, 50, 0, 44), dim2(0.5, -25, 0, 10))
            Cfg.CreateR6Part("Torso", dim2(0, 84, 0, 90), dim2(0.5, -42, 0, 56))
            Cfg.CreateR6Part("LeftArm", dim2(0, 40, 0, 90), dim2(0.5, -86, 0, 56))
            Cfg.CreateR6Part("RightArm", dim2(0, 40, 0, 90), dim2(0.5, 46, 0, 56))
            Cfg.CreateR6Part("LeftLeg", dim2(0, 40, 0, 90), dim2(0.5, -42, 0, 148))
            Cfg.CreateR6Part("RightLeg", dim2(0, 40, 0, 90), dim2(0.5, 2, 0, 148))
            ...
            Cfg.R6Parts.HumanoidRootPart = R6HRPOut
            R6HRPOut.MouseButton1Click:Connect(function()
                if Cfg.R6Selected.HumanoidRootPart then
                    Cfg.R6Selected.HumanoidRootPart = nil
                    R6HRPOut.BackgroundColor3 = rgb(40, 40, 40)
                else
                    Cfg.R6Selected.HumanoidRootPart = true
                    R6HRPOut.BackgroundColor3 = Cfg.HighlightColor
                end
            end)

            -- GENERATE R15 PARTS
            Cfg.CreateR15Part("Head", dim2(0, 50, 0, 44), dim2(0.5, -25, 0, 8))
            Cfg.CreateR15Part("UpperTorso", dim2(0, 84, 0, 76), dim2(0.5, -42, 0, 56))
            Cfg.CreateR15Part("LowerTorso", dim2(0, 84, 0, 10), dim2(0.5, -42, 0, 136))
            Cfg.CreateR15Part("LeftUpperArm", dim2(0, 40, 0, 34), dim2(0.5, -86, 0, 56))
            Cfg.CreateR15Part("RightUpperArm", dim2(0, 40, 0, 34), dim2(0.5, 46, 0, 56))
            Cfg.CreateR15Part("LeftLowerArm", dim2(0, 40, 0, 42), dim2(0.5, -86, 0, 94))
            Cfg.CreateR15Part("RightLowerArm", dim2(0, 40, 0, 42), dim2(0.5, 46, 0, 94))
            Cfg.CreateR15Part("LeftHand", dim2(0, 40, 0, 6), dim2(0.5, -86, 0, 140))
            Cfg.CreateR15Part("RightHand", dim2(0, 40, 0, 6), dim2(0.5, 46, 0, 140))
            Cfg.CreateR15Part("LeftUpperLeg", dim2(0, 40, 0, 34), dim2(0.5, -42, 0, 150))
            Cfg.CreateR15Part("RightUpperLeg", dim2(0, 40, 0, 34), dim2(0.5, 2, 0, 150))
            Cfg.CreateR15Part("LeftLowerLeg", dim2(0, 40, 0, 42), dim2(0.5, -42, 0, 188))
            Cfg.CreateR15Part("RightLowerLeg", dim2(0, 40, 0, 42), dim2(0.5, 2, 0, 188))
            Cfg.CreateR15Part("LeftFoot", dim2(0, 40, 0, 6), dim2(0.5, -42, 0, 234))
            Cfg.CreateR15Part("RightFoot", dim2(0, 40, 0, 6), dim2(0.5, 2, 0, 234))
            ...
            Cfg.R15Parts.HumanoidRootPart = R15HRPOut
            R15HRPOut.MouseButton1Click:Connect(function()
                if Cfg.R15Selected.HumanoidRootPart then
                    Cfg.R15Selected.HumanoidRootPart = nil
                    R15HRPOut.BackgroundColor3 = rgb(40, 40, 40)
                else
                    Cfg.R15Selected.HumanoidRootPart = true
                    R15HRPOut.BackgroundColor3 = Cfg.HighlightColor
                end
            end)

            -- MULTI TOGGLE LOGIC
            Items.R6MultiToggle.MouseButton1Click:Connect(function()
                Cfg.R6MultiMode = not Cfg.R6MultiMode
                Items.R6MultiToggle.Text = Cfg.R6MultiMode and "Multi: ON" or "Multi: OFF"
                for name, btn in pairs(Cfg.R6Parts) do
                    Cfg.R6Selected[name] = nil
                    btn.BackgroundColor3 = (name == "HumanoidRootPart") and rgb(40, 40, 40) or rgb(60, 60, 60)
                end
            end)

            Items.R15MultiToggle.MouseButton1Click:Connect(function()
                Cfg.R15MultiMode = not Cfg.R15MultiMode
                Items.R15MultiToggle.Text = Cfg.R15MultiMode and "Multi: ON" or "Multi: OFF"
                for name, btn in pairs(Cfg.R15Parts) do
                    Cfg.R15Selected[name] = nil
                    btn.BackgroundColor3 = (name == "HumanoidRootPart") and rgb(40, 40, 40) or rgb(60, 60, 60)
                end
            end)
            ...
            local function createButton(text, xPos, color, callback)
                local btn = Library:Create("TextButton", {
                    Parent = Items.BottomControls;
                    Size = dim2(0, 80, 0, 25);
                    Position = dim2(0, xPos, 0, 5);
            ...
            createButton("Get R6", 10, rgb(50, 50, 50), function()
                local list = {}
                for k, _ in pairs(Cfg.R6Selected) do table.insert(list, k) end
                print("R6 Selected:", table.concat(list, ", "))
            end)

            createButton("Get R15", 100, rgb(50, 50, 50), function()
                local list = {}
                for k, _ in pairs(Cfg.R15Selected) do table.insert(list, k) end
                print("R15 Selected:", table.concat(list, ", "))
            end)

            createButton("Clear R6", 190, rgb(150, 50, 50), function()
                for name, btn in pairs(Cfg.R6Parts) do
                    Cfg.R6Selected[name] = nil
                    btn.BackgroundColor3 = (name == "HumanoidRootPart") and rgb(40, 40, 40) or rgb(60, 60, 60)
                end
            ...
            createButton("Clear R15", 280, rgb(150, 50, 50), function()
                for name, btn in pairs(Cfg.R15Parts) do
                    Cfg.R15Selected[name] = nil
                    btn.BackgroundColor3 = (name == "HumanoidRootPart") and rgb(40, 40, 40) or rgb(60, 60, 60)
                end
            ...
            createButton("Set Example", 370, rgb(50, 150, 50), function()
                for name, btn in pairs(Cfg.R6Parts) do
                    Cfg.R6Selected[name] = nil
                    btn.BackgroundColor3 = (name == "HumanoidRootPart") and rgb(40, 40, 40) or rgb(60, 60, 60)
                end
                Cfg.R6Selected.Head = true
                Cfg.R6Selected.Torso = true
                Cfg.R6Parts.Head.BackgroundColor3 = Cfg.HighlightColor
                Cfg.R6Parts.Torso.BackgroundColor3 = Cfg.HighlightColor

                for name, btn in pairs(Cfg.R15Parts) do
                    Cfg.R15Selected[name] = nil
                    btn.BackgroundColor3 = (name == "HumanoidRootPart") and rgb(40, 40, 40) or rgb(60, 60, 60)
                end
                Cfg.R15Selected.Head = true
                Cfg.R15Selected.UpperTorso = true
                Cfg.R15Parts.Head.BackgroundColor3 = Cfg.HighlightColor
                Cfg.R15Parts.UpperTorso.BackgroundColor3 = Cfg.HighlightColor
            end)
